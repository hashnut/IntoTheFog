...
// Cross Module References
	ARENABATTLE_API UScriptStruct* Z_Construct_UScriptStruct_FABEnemyData();
...
static_assert(std::is_polymorphic<FABEnemyData>() == std::is_polymorphic<FTableRowBase>(), "USTRUCT FABEnemyData cannot be polymorphic unless super FTableRowBase is polymorphic");

class UScriptStruct* FABEnemyData::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern ARENABATTLE_API uint32 Get_Z_Construct_UScriptStruct_FABEnemyData_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FABEnemyData, Z_Construct_UPackage__Script_ArenaBattle(), TEXT("ABEnemyData"), sizeof(FABEnemyData), Get_Z_Construct_UScriptStruct_FABEnemyData_Hash());
	}
	return Singleton;
}
template<> ARENABATTLE_API UScriptStruct* StaticStruct<FABEnemyData>()
{
	return FABEnemyData::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FABEnemyData(FABEnemyData::StaticStruct, TEXT("/Script/ArenaBattle"), TEXT("ABEnemyData"), false, nullptr, nullptr);
static struct FScriptStruct_ArenaBattle_StaticRegisterNativesFABEnemyData
{
	FScriptStruct_ArenaBattle_StaticRegisterNativesFABEnemyData()
	{
		UScriptStruct::DeferCppStructOps<FABEnemyData>(FName(TEXT("ABEnemyData")));
	}
} ScriptStruct_ArenaBattle_StaticRegisterNativesFABEnemyData;
	struct Z_Construct_UScriptStruct_FABEnemyData_Statics
	{
#if WITH_METADATA
...
#endif
		static const UE4CodeGen_Private::FNamePropertyParams NewProp_Monster;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FABEnemyData_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/ABGameInstance.h" },
	};
#endif
	void* Z_Construct_UScriptStruct_FABEnemyData_Statics::NewStructOps()
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FABEnemyData>();
	}
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FABEnemyData_Statics::NewProp_Monster_MetaData[] = {
		{ "Category", "EnemyData" },
		{ "ModuleRelativePath", "Public/ABGameInstance.h" },
	};
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FABEnemyData_Statics::NewProp_Monster = { "Monster", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FABEnemyData, Monster), METADATA_PARAMS(Z_Construct_UScriptStruct_FABEnemyData_Statics::NewProp_Monster_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FABEnemyData_Statics::NewProp_Monster_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FABEnemyData_Statics::NewProp_MaxHP_MetaData[] = {
		{ "Category", "EnemyData" },
		{ "ModuleRelativePath", "Public/ABGameInstance.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FABEnemyData_Statics::NewProp_MaxHP = { "MaxHP", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FABEnemyData, MaxHP), METADATA_PARAMS(Z_Construct_UScriptStruct_FABEnemyData_Statics::NewProp_MaxHP_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FABEnemyData_Statics::NewProp_MaxHP_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FABEnemyData_Statics::NewProp_Attack_MetaData[] = {
		{ "Category", "EnemyData" },
		{ "ModuleRelativePath", "Public/ABGameInstance.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FABEnemyData_Statics::NewProp_Attack = { "Attack", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FABEnemyData, Attack), METADATA_PARAMS(Z_Construct_UScriptStruct_FABEnemyData_Statics::NewProp_Attack_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FABEnemyData_Statics::NewProp_Attack_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FABEnemyData_Statics::NewProp_DropExp_MetaData[] = {
		{ "Category", "EnemyData" },
		{ "ModuleRelativePath", "Public/ABGameInstance.h" },
	};
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FABEnemyData_Statics::NewProp_DropExp = { "DropExp", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FABEnemyData, DropExp), METADATA_PARAMS(Z_Construct_UScriptStruct_FABEnemyData_Statics::NewProp_DropExp_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FABEnemyData_Statics::NewProp_DropExp_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FABEnemyData_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FABEnemyData_Statics::NewProp_Monster,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FABEnemyData_Statics::NewProp_MaxHP,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FABEnemyData_Statics::NewProp_Attack,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FABEnemyData_Statics::NewProp_DropExp,
	};
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FABEnemyData_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_ArenaBattle,
		Z_Construct_UScriptStruct_FTableRowBase,
		&NewStructOps,
		"ABEnemyData",
		sizeof(FABEnemyData),
		alignof(FABEnemyData),
		Z_Construct_UScriptStruct_FABEnemyData_Statics::PropPointers,
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FABEnemyData_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FABEnemyData_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FABEnemyData_Statics::Struct_MetaDataParams))
	};
	UScriptStruct* Z_Construct_UScriptStruct_FABEnemyData()
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FABEnemyData_Hash();
		UPackage* Outer = Z_Construct_UPackage__Script_ArenaBattle();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("ABEnemyData"), sizeof(FABEnemyData), Get_Z_Construct_UScriptStruct_FABEnemyData_Hash(), false);
#else
		static UScriptStruct* ReturnStruct = nullptr;
#endif
		if (!ReturnStruct)
		{
			UE4CodeGen_Private::ConstructUScriptStruct(ReturnStruct, Z_Construct_UScriptStruct_FABEnemyData_Statics::ReturnStructParams);
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FABEnemyData_Hash() { return 3185272845U; }
...
static struct FScriptStruct_ArenaBattle_StaticRegisterNativesFABCharacterData
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FABCharacterData_Hash() { return 829679529U; }
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ABEnemyTable_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ABEnemyTable;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UABGameInstance_Statics::NewProp_ABEnemyTable_MetaData[] = {
		{ "ModuleRelativePath", "Public/ABGameInstance.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UABGameInstance_Statics::NewProp_ABEnemyTable = { "ABEnemyTable", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UABGameInstance, ABEnemyTable), Z_Construct_UClass_UDataTable_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UABGameInstance_Statics::NewProp_ABEnemyTable_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UABGameInstance_Statics::NewProp_ABEnemyTable_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UABGameInstance_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UABGameInstance_Statics::NewProp_ABEnemyTable,
	};
	...
	IMPLEMENT_CLASS(UABGameInstance, 2645949205);
